package com.knowei.common.utils.poi;

import com.knowei.common.annotation.Excel;
import com.knowei.common.annotation.Excel.ColumnType;
import com.knowei.common.annotation.Excel.Type;
import com.knowei.common.annotation.Excels;
import com.knowei.common.config.RuoYiConfig;
import com.knowei.common.core.domain.AjaxResult;
import com.knowei.common.core.text.Convert;
import com.knowei.common.exception.UtilException;
import com.knowei.common.utils.DateUtils;
import com.knowei.common.utils.DictUtils;
import com.knowei.common.utils.StringUtils;
import com.knowei.common.utils.file.FileTypeUtils;
import com.knowei.common.utils.file.FileUtils;
import com.knowei.common.utils.file.ImageUtils;
import com.knowei.common.utils.reflect.ReflectUtils;
                ...
                if (Collection.class.isAssignableFrom(field.getType())) {
                    ...
                    if (subFieldSize > 1) {
                        CellRangeAddress cellAddress =
                            new CellRangeAddress(rownum, rownum, column, column + subFieldSize - 1);
                ...
                if (Collection.class.isAssignableFrom(field.getType())) {
                    ...
                    if (maxSubListSize > 1 && excel.needMerge()) {
                        sheet.addMergedRegion(
                            new CellRangeAddress(currentRowNum, currentRowNum + maxSubListSize - 1, column, column));
                    }
                    column++;
                }
            }
    ...
    public Cell createHeadCell(Excel attr, Row row, int column) {
        ...
        if (isSubList()) {
            ...
            sheet.setDefaultColumnStyle(column, styles.get(
                StringUtils.format("data_{}_{}_{}_{}_{}", attr.align(), attr.color(), attr.backgroundColor(),
                    attr.cellType(), attr.wrapText())));
            if (attr.needMerge()) {
    ...
    public List<Object[]> getFields() {
        ...
        if (StringUtils.isNotEmpty(includeFields)) {
            for (Field field : tempFields) {
                if (ArrayUtils.contains(this.includeFields, field.getName()) || field.isAnnotationPresent(
                    Excels.class)) {
    ...
    public void addField(List<Object[]> fields, Field field) {
        ...
        if (field.isAnnotationPresent(Excels.class)) {
            ...
            for (Excel attr : excels) {
                if (StringUtils.isNotEmpty(includeFields)) {
                    if (ArrayUtils.contains(this.includeFields,
