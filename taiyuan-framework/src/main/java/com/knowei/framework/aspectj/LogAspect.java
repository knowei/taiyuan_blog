...
import com.knowei.common.enums.BusinessStatus;
import com.knowei.common.enums.HttpMethod;
import com.knowei.common.filter.PropertyPreExcludeFilter;
import com.knowei.common.utils.ExceptionUtil;
...
import com.knowei.system.domain.SysOperLog;
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            if (e != null) {
                ...
                operLog.setErrorMsg(
                    StringUtils.substring(Convert.toStr(e.getMessage(), ExceptionUtil.getExceptionMessage(e)), 0,
                        2000));
            }
            // 设置方法名称
